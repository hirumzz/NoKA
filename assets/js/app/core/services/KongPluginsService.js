            ...
            return [
              ...
              },
              {
                ...
                plugins: {
                  ...
                  "standard-webhooks": {
                    description: "Verify webhooks signatures against Standard Webhook specs"
                  }
                }
              },
              {
                ...
                plugins: {
                  ...
                  "grpc-gateway": {
                    description: "Expose gRPC services as REST APIs"
                  },
                  "grpc-web": {
                    description: "Allow browser clients to access gRPC services via gRPC-Web protocol"
                  }
                }
              },
              {
              ...
              {
                name: "AI Gateway",
                description: "Integrate, secure, and manage AI/LLM requests",
                icon: "mdi-brain",
                hasConsumerPlugins: true,
                plugins: {
                  "ai-proxy": {
                    description: "Multi-provider LLM request proxying"
                  },
                  "ai-prompt-guard": {
                    description: "Validate LLM prompts against rules"
                  },
                  "ai-prompt-template": {
                    description: "Manage prompts with custom templates"
                  },
                  "ai-prompt-decorator": {
                    description: "Append prefix/suffix to LLM prompts"
                  },
                  "ai-request-transformer": {
                    description: "Modify request payload for AI services"
                  },
                  "ai-response-transformer": {
                    description: "Modify response payload from AI services"
                  }
                }
              },
              {
                ...
                plugins: {
                  ...
                  "opentelemetry": {
                    description: "Propagate OpenTelemetry tracing spans and report metrics."
                  }
                }
              },
              {
                ...
                plugins: {
                  ...
                  "redirect": {
                    description: "Redirect requests on the fly"
                  }
                }
              },
              {
