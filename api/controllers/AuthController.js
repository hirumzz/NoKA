    ...
    sails.models.user
      ...
      .exec(function (err, user) {
        ...
        sails.models.passport
          ...
          EventService.broadcast(req, 'user', 'create', user);
    ...
    sails.models.settings
      ...
      .exec(function (err, settings) {
        ...
        if (!_settings.signup_require_activation) {
          ...
          if (data.role) {
            data.admin = (data.role === 'admin');
          } else {
            data.role = data.admin ? 'admin' : 'viewer';
          }
      ...
      sails.models.user.update({
        ...
        .exec(function (err, updated) {
          ...
          if (updated && updated.length) {
            EventService.broadcast(req, 'user', 'update', updated[0]);
          }
